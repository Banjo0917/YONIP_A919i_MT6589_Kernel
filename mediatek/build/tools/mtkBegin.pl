...
if ($prj ne "tinno89_we_jb2" && $prj ne "banyan_addon")
{
    system("rsync -a --delete-after --exclude=.git --exclude=artifacts/out/target/product/* vendor/mediatek/tinno89_we_jb2/ vendor/mediatek/$prj ");
    system("rsync -a --delete-after --exclude=.git vendor/mediatek/tinno89_we_jb2/artifacts/out/target/product/tinno89_we_jb2/ vendor/mediatek/$prj/artifacts/out/target/product/$prj");
    system("sed -i s/\\\\/tinno89_we_jb2\\\\//\\\\/$prj\\\\//g vendor/mediatek/$prj/artifacts/target.txt");
}
