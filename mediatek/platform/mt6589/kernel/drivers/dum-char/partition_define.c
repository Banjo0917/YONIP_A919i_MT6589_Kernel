...
struct excel_info PartInfo[PART_NUM]={
			...
			{"misc",393216,0x3980000, EMMC, 0,USER},
			{"logo",3145728,0x39e0000, EMMC, 0,USER},
			{"ebr2",524288,0x3ce0000, EMMC, 0,USER},
			{"expdb",786432,0x3d60000, EMMC, 0,USER},
			{"android",943718400,0x3e20000, EMMC, 5,USER},
			{"cache",537919488,0x3c220000, EMMC, 6,USER},
			{"usrdata",1611661312,0x5c320000, EMMC, 7,USER},
			{"fat",0,0xbc420000, EMMC, 8,USER},
